                                ...
                                <div class="widget-content-left">
                                    <div class="btn-group">
                                        <a data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" class="p-0 btn">
                                           <?php
                                                 echo "<img width='42' class='rounded-circle' src='".$image."' alt=''> "; 
                                            ?>
                        ...
                        <div class="app-page-title">
                            ...
                            <div class="col-md-12">
                                <div class="main-card mb-3 card">
                                    <div class="card-header">Active Courses
                                    </div>
                                    <div class="table-responsive">
                                        <table class="align-middle mb-0 table table-borderless table-striped table-hover">
                                            ...
                                            while($row = $result->fetch_assoc()) { 
                                                ...
                                                echo "<img width='40' class='rounded-circle' src='".$row['img_url']."' alt=''>";
                                                echo "</div>";
                                                echo "</div>";
                                                ...
                                                echo "</td>";
                                                echo "<td class='text-center'>";
                                                echo "<button type='button' id='PopoverCustomT-1' class='btn btn-primary btn-sm'>Regsiter</button>";
                                                echo "</td>";
                                                echo "</tr>";
                        ...
                        <div class="col-md-6">
                                    <div id="accordion" class="accordion-wrapper mb-3">
                                        ...
                                        <div class="card1">
                                            ...
                                            if ($result->num_rows > 0) {
                                            while($row = $result->fetch_assoc()) { 
                                                 echo "<div id='headingTwo' class='card-header'>";
                                                echo "<button type='button' data-toggle='collapse' data-target='#collapseOne".$row['C_ID']."' aria-expanded='false' aria-controls='collapseTwo' class='text-left m-0 p-0 btn btn-link btn-block'>";
                                                echo "<h5 class='m-0 p-0'>";
                                                echo $row['c_name'];
                                                echo "</h5></button>";
                                            echo "</div>";
                                            echo "<div data-parent='#accordion' id='collapseOne".$row['C_ID']."' class='collapse'>";
